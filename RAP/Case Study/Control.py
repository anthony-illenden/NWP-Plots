...
cf = ax.contourf(thetae_h850_da.metpy.x, thetae_h850_da.metpy.y, ndimage.gaussian_filter(lapse_rate_2, sigma=2, order=0),
                 levels=range(-51, 51, 3), transform=ccrs.PlateCarree(), cmap=reversed_map)
c = ax.contour(thetae_h850_da.metpy.x, thetae_h850_da.metpy.y, ndimage.gaussian_filter(lapse_rate_2, sigma=2, order=0),
...
ax.streamplot(lons, lats, uwnd_total_h700h1000.to('kt'), vwnd_total_h700h1000.to('kt'), color='black', transform=ccrs.PlateCarree(), zorder=2, arrowstyle='->',density=1)
